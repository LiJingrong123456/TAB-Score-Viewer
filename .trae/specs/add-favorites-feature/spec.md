...
The system SHALL reuse the existing show\_display() logic to open files from the favorites list.
...
The system SHALL provide trilingual support (zh\_CN / en\_US / ru\_RU) for all new UI text.
...
### Requirement: SelectionWindow\.init\_ui()
